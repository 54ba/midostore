...
export default function ScrapingDashboard() {
    ...
    const startNewJob = async (e: React.FormEvent) => {
        e.preventDefault();
        try {
            console.log('Starting new job with data:', newJobData);
            ...
            if (response.ok && data.success) {
                ...
                console.error('Failed to start job:', data.error || 'Unknown error');
                alert(`Failed to start job: ${data.error || 'Unknown error'}`);
            }
        } catch (error) {
            console.error('Error starting job:', error);
            alert('Network error occurred while starting job');
        }
    };
            ...
            <div className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Scraping Dashboard</h1>
            ...
            {showNewJobForm && (
                <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
                    <div className="relative top-20 mx-auto p-5 border border-gray-200 dark:border-gray-700 w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
                        <div className="mt-3">
                            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Start New Scraping Job</h3>
