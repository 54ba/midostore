        ...
        <div className="flex-1 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p id="success-description" className="text-lg text-gray-600 dark:text-gray-300 mb-8">
      ...
      <div className="flex-1 py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p id="contact-page-description" className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
