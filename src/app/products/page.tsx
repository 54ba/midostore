...
const mockProducts: Product[] = [
    {
        ...
        supplier: { name: 'TechCorp', verified: true, goldMember: true }
    },
    {
        id: 'mock-2',
        title: 'Gaming Console Set',
        description: 'Complete gaming setup with controllers and popular games',
        price: 199,
        currency: 'USD',
        images: ['/api/placeholder/400/400'],
        rating: 4.8,
        ...
        soldCount: 89,
        category: 'electronics',
        supplier: { name: 'GameWorld', verified: true, goldMember: true }
    },
    {
        id: 'mock-3',
        title: 'Luxury Makeup Kit',
        description: 'Professional makeup collection with premium brushes and palettes',
        price: 89,
        currency: 'USD',
        images: ['/api/placeholder/400/400'],
        rating: 4.6,
        ...
        soldCount: 234,
        category: 'beauty',
        supplier: { name: 'BeautyPro', verified: true, goldMember: true }
    },
    {
        id: 'mock-4',
        title: 'Smart Home Hub',
        description: 'Control your home with voice commands and mobile app',
        price: 149,
        currency: 'USD',
        images: ['/api/placeholder/400/400'],
        rating: 4.4,
        ...
        soldCount: 67,
        category: 'electronics',
        supplier: { name: 'SmartHome', verified: true, goldMember: true }
    }
];
    ...
    const fetchProducts = useCallback(async () => {
        try {
            ...
            if (data.success && data.data.products.length > 0) {
                ...
                // Use mock data if API returns no products
                        ...
                        <div>
                            ...
                            {useMockData && (
                                <p className="mt-2 text-sm text-amber-600 bg-amber-50 px-3 py-2 rounded-lg">
                                    ⚠️ Showing sample products (API connection issue)
                                </p>
                            )}
                        </div>
