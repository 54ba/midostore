...
ALTER TABLE "products_localizations" ADD CONSTRAINT "products_localizations_productId_fkey" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE;
